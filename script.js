...
const T = {
  fr: {
    ...
    about_text:   "Développeur web indépendant basé en Île-de-France, je conçois des <strong>sites vitrines sur mesure</strong> pour les commerces locaux et les associations. Tous les projet sont pensé pour refléter votre identité afin de marquer par une vraie présence en ligne.",
    ...
    ct_p:         "Que ce soit pour un site vitrine, une refonte ou un outil sur mesure — parlons-en. Je réponds généralement le jour même.",
  ...
  en: {
    ...
    about_text:   "Freelance web developer based near Paris, I build <strong>custom showcase websites</strong> for local businesses and associations. Every project is crafted to reflect my client's identity to offer a real online presence.",
